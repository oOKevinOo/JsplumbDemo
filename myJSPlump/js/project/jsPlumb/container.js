...
function nodeContainer() {
    ...
    this.addConnection = function (sourceId, targetId, uuid, suuid, tuuid) {
        var connection = {
            uuid: uuid,
            sourceId: sourceId,
            targetId: targetId,
    ...
    this.removeConnection = function (key, sourceId, targetId) {
        var result = this.nodes.get(key);
        var connections = result.connections;
        ...
        for (var i = 0; i < connections.length; i++) {
            ...
            if (connections[i]['suuid'] != sourceId) {
                ...
                if (connections[i]['tuuid'] != targetId) {
                    ...
                    //删除
                    Util.delConnection(connections[i]['uuid']);
